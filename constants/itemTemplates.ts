...
const NAME_COMPONENTS = {
  ...
  legendaryMaterials: ['Vault-Tec', 'Enclave', 'Bos', 'Raider', 'Mutant', 'Plasma', 'Nuclear', 'Cyber', 'Atomic', 'Relic', 'Titan', 'Apex', 'Zenith', 'Nova'],
  // Material words (Mythic)
  immortalMaterials: ['G.E.C.K.', 'Zetan', 'Alien', 'Cryo', 'Primordial', 'Omega', 'Absolute', 'Unstoppable', 'Overseer', 'Genesis', 'Infinity', 'Supreme'],
...
function generateEquipmentDescription(
  ...
  const armorDescriptions: Record<ItemRarity, string[]> = {
    ...
    Mythic: [
      ...
      'An artifact of cosmic protection, absolute in its defense.',
      'Possesses a divine presence, making its wearer untouchable.',
      'The ultimate defense, a relic of gods from a forgotten age.',
      'Born of myth, its surface reflects the very fabric of space.',
      'Indestructible and eternal, the apex of wasteland armor.',
      'Defies reality, its defensive power is beyond all measure.',
      'Absolute protection, capable of neutralizing any threat.',
    ],
  };
...
// generateHerbName already defined above
...
// generateMaterialName already defined above
...
/**
 * Get item templates by type and rarity
 */
